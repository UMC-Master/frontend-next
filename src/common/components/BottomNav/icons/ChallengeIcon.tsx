...
import ChallengeDisabled from '@/assets/svgs/challenge_disabled.svg';
import ChallengeBlur from '@/assets/svgs/challenge_blur.svg';
import ChallengeShadow from '@/assets/svgs/challenge_shadow.svg';

export function ChallengeIcon({ isActive, animationProgress }: NavIconProps) {
