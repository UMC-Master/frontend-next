...
이 약관은 재단법인예술경영지원센터(이하 “센터”)가 운영하는 대표누리집(이하 “누리집”이라고 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”)를 이용함에 있어 이용자와 누리집의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
...
④ 다른 사람의 누리집 이용을 방해하거나 정보를 도용하는 등의 행위를 하였을 때
...
1. 누리집의 회원정보는 “개인정보보호법” 및 센터 “개인정보처리방침” 의해 보호합니다.
...
2. 누리집은 회원의 개인정보를 본인의 승낙 없이 타인에게 누설, 배포하지 않습니다. 다만, 개인정보보호법 제18조에 의해 제공해야할 경우 그러하지 아니합니다.
